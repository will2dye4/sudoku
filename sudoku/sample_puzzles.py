...
def get_puzzle_by_name(puzzle_name: AnyStr) -> AnyStr:
    ...
    if num > len(hard_puzzles):
        raise InvalidPuzzleError(puzzle_name, f'puzzle number must be between 1 and {len(hard_puzzles)}')
    return hard_puzzles[num - 1]
...
half_solved = '6.2.8.9...34..9.52.71.25.64.67.12..3..579.6...9.5.3.71.8..3.2.5..31.6.8.7...58.1.'
mostly_solved = '6.248.9378346.9152971.25864.678125.331579.62829.563.71.8..3.2.55.31.6.8.7.9.58316'
